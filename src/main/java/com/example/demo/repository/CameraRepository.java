...
//    private String rtspUrl;
    String saveSql="insert into camera (id,ip,port,origin_pos,way_num,is_in_machine,account,password,rtsp_url) values(?1,?2,?3,?4,?5,?6,?7,?8,?9)";
    ...
    public void save(Long id,String ip,int port,String originPos,int wayNum ,Boolean isInMachine,String account,String password,String rtspUrl);
