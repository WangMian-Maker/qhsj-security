...
public class AmphibiousController {
    ...
    public List<GradeCount> findCount(){
        ...
        tmp.add(amphibiousService.findCountByGradeAndType(1L,"两栖"));
        tmp.add(amphibiousService.findCountByGradeAndType(2L,"两栖"));
        tmp.add(amphibiousService.findCountByGradeAndType(3L,"两栖"));
        tmp.add(amphibiousService.findCountByGradeAndType(4L,"两栖"));
        return tmp;
    }
}
