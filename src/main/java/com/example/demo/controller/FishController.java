...
public class FishController {
    ...
    public List<GradeCount> findCount(){
        ...
        tmp.add(birdService.findCountByGradeAndType(1L,"鱼类"));
        tmp.add(birdService.findCountByGradeAndType(2L,"鱼类"));
        tmp.add(birdService.findCountByGradeAndType(3L,"鱼类"));
        tmp.add(birdService.findCountByGradeAndType(4L,"鱼类"));
        return tmp;
    }
}
